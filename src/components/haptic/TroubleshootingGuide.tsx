...
export function TroubleshootingGuide() {
  ...
  const runDiagnostics = async () => {
    ...
    // Check 1: Settings store initialized
      ...
      content: (
        <div className="space-y-3 text-sm text-muted-foreground">
          <p>
            ...
            applied when creating new notes, this guide will help you identify and resolve the issue.
          </p>
      ...
      content: (
        <div className="space-y-4 text-sm">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              The note creation function may not be reading from the settings store. This is a 
              code integration issue where <code className="px-1 py-0.5 rounded bg-muted">createFile()</code> needs 
              to apply the selected template.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Outdated cached JavaScript may contain old store logic that doesn't properly 
              apply settings to new notes.
            </p>
          </div>
        </div>
      ),
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="space-y-3">
            <div className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-muted flex items-center justify-center text-xs font-medium shrink-0">1</span>
              <div>
                <p className="font-medium text-foreground">Open Settings Modal</p>
                <p className="text-muted-foreground text-xs">Click the gear icon in the sidebar to open settings.</p>
              </div>
            </div>
            
            <div className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-muted flex items-center justify-center text-xs font-medium shrink-0">2</span>
              <div>
                ...
                {settings && (
                  <div className="mt-2 p-2 rounded bg-muted text-xs">
                    <p>Template: <strong>{settings.templateStyle}</strong></p>
                    <p>Mode: <strong>{settings.defaultModeMarkdown ? 'Markdown' : 'Rich Text'}</strong></p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-muted flex items-center justify-center text-xs font-medium shrink-0">3</span>
              <div>
            ...
            <div className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-muted flex items-center justify-center text-xs font-medium shrink-0">4</span>
              <div>
